...
window.HareWordScramblePlatformEngine = (() => {
  const VERSION = "word-scramble-platform-engine-v2.0";
  ...
  const CSS = `
    ...
    @media(max-width:900px){
      #hp-wordscramble-container .hpwsc-layout { grid-template-columns:1fr; height:auto; }
      #hp-wordscramble-container .hpwsc-card,
      #hp-wordscramble-container .hpwsc-shell,
      #hp-wordscramble-container .hpwsc-puzzle-panel,
      #hp-wordscramble-container .hpwsc-word-panel { height:auto; }
  ...
  function injectStyles(){
    if (document.getElementById("hp-word-scramble-platform-engine-css-v16")) return;
    const style = document.createElement("style");
    style.id = "hp-word-scramble-platform-engine-css-v16";
