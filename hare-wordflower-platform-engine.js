...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-engine-v1.1";
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-layout { display:grid; grid-template-columns:minmax(0,1fr) 300px; gap:20px; align-items:stretch; }
    #hp-wordflower-container .hpwf-progress-wrap { grid-column:1 / -1; }
    #hp-wordflower-container .hpwf-panel { background:#fff; border:1px solid #e9eef3; border-radius:20px; box-shadow:0 12px 34px rgba(0,0,0,.055); padding:16px; min-width:0; }
    #hp-wordflower-container .hpwf-main-panel { overflow:visible; }
    #hp-wordflower-container .hpwf-word-panel { display:flex; flex-direction:column; overflow:hidden; min-height:0; }
    #hp-wordflower-container .hpwf-life-wrap { grid-column:1 / -1; }

    #hp-wordflower-container .hpwf-progress-card { background:linear-gradient(135deg,#fff 0%,#fff 64%,#fff5f6 64%,#fff5f6 100%); border:1px solid #f7c7ca; border-radius:18px; padding:12px 14px 14px; }
    #hp-wordflower-container .hpwf-progress-top { display:flex; align-items:center; justify-content:space-between; gap:12px; margin-bottom:8px; }
    ...
    #hp-wordflower-container .hpwf-progress-percent { font-size:26px; line-height:1; font-weight:900; color:#9d4147; }
    #hp-wordflower-container .hpwf-vine { position:relative; display:grid; grid-template-columns:repeat(7,1fr); align-items:start; gap:0; padding:10px 4px 4px; }
    #hp-wordflower-container .hpwf-vine::before { content:""; position:absolute; left:8%; right:8%; top:27px; height:5px; border-radius:999px; background:#f1d4d6; z-index:0; }
    #hp-wordflower-container .hpwf-vine-fill { position:absolute; left:8%; top:27px; height:5px; border-radius:999px; background:#F68D91; z-index:1; transition:width .25s ease; max-width:84%; }
    ...
    #hp-wordflower-container .hpwf-node-dot { width:32px; height:32px; border-radius:50%; border:2px solid #f1d4d6; background:#fff; color:#b7777c; display:flex; align-items:center; justify-content:center; transition:all .2s ease; }
    #hp-wordflower-container .hpwf-node-dot .material-symbols-outlined { font-size:19px; font-variation-settings:'FILL' 0,'wght' 500,'GRAD' 0,'opsz' 24; }
    ...
    #hp-wordflower-container .hpwf-node.current .hpwf-node-dot { width:40px; height:40px; box-shadow:0 7px 18px rgba(246,141,145,.35); transform:translateY(-3px); }
    #hp-wordflower-container .hpwf-node-label { font-size:9px; line-height:1.05; font-weight:900; text-align:center; color:#777; max-width:72px; }
    #hp-wordflower-container .hpwf-node.current .hpwf-node-label { color:#9d4147; }
    #hp-wordflower-container .hpwf-progress-meta { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:8px; margin-top:8px; }
    #hp-wordflower-container .hpwf-progress-stat { background:#fff; border:1px solid #f7c7ca; border-radius:14px; padding:7px 8px; text-align:center; }
    #hp-wordflower-container .hpwf-progress-stat strong { display:block; font-size:16px; color:#9d4147; font-weight:900; line-height:1.1; }
    #hp-wordflower-container .hpwf-progress-stat span { display:block; margin-top:3px; font-size:10px; color:#555; font-weight:900; text-transform:uppercase; line-height:1.1; }
    ...
    #hp-wordflower-container .hpwf-flower-wrap { display:flex; justify-content:center; margin:2px auto 13px; }
    #hp-wordflower-container .hpwf-flower { position:relative; width:340px; height:340px; max-width:100%; }
    #hp-wordflower-container .hpwf-flower-core { position:absolute; left:94px; top:94px; width:152px; height:152px; border-radius:50%; background:radial-gradient(circle at 45% 35%,#fff 0%,#fff9f9 44%,#ffe6e8 100%); border:8px solid #fff; box-shadow:0 10px 24px rgba(157,65,71,.16), inset 0 0 0 8px #ffd0d3; }
    #hp-wordflower-container .hpwf-letter { position:absolute; border-radius:50%; border:8px solid #fff; background:radial-gradient(circle at 45% 35%,#fff 0%,#fff 58%,#fff8f8 100%); color:#9d4147; font-weight:900; font-size:29px; display:flex; align-items:center; justify-content:center; cursor:pointer; font-family:inherit; transition:transform .12s ease, background .18s ease, border-color .18s ease; user-select:none; box-shadow:0 9px 18px rgba(157,65,71,.12), inset 0 0 0 5px #f8c1c5; }
    #hp-wordflower-container .hpwf-letter:hover { transform:translateY(-2px); background:#fff5f6; }
    #hp-wordflower-container .hpwf-center-letter { left:112px; top:112px; width:116px; height:116px; background:radial-gradient(circle at 40% 30%,#ff9ba1 0%,#F68D91 55%,#ef6f77 100%); color:#fff; border-color:#fff; z-index:3; box-shadow:0 10px 24px rgba(246,141,145,.42), inset 0 0 0 6px #F68D91; }
    #hp-wordflower-container .hpwf-outer-letter { width:104px; height:104px; z-index:2; }
    #hp-wordflower-container .hpwf-pos-0 { left:118px; top:0; }
    #hp-wordflower-container .hpwf-pos-1 { left:222px; top:60px; }
    #hp-wordflower-container .hpwf-pos-2 { left:222px; top:176px; }
    #hp-wordflower-container .hpwf-pos-3 { left:118px; top:236px; }
    #hp-wordflower-container .hpwf-pos-4 { left:14px; top:176px; }
    #hp-wordflower-container .hpwf-pos-5 { left:14px; top:60px; }

    #hp-wordflower-container .hpwf-actions { display:flex; flex-wrap:wrap; gap:10px; justify-content:center; margin:0 auto 10px; }
    #hp-wordflower-container .hpwf-actions button, #hp-wordflower-container .hpwf-tools summary, #hp-wordflower-container .hpwf-tool-panel button { appearance:none; border-radius:14px; padding:10px 16px; font-size:15px; font-weight:900; font-family:inherit; cursor:pointer; border:2px solid #f7c7ca; background:#fff; color:#9d4147; transition:all .18s ease; }
    #hp-wordflower-container .hpwf-actions button:hover, #hp-wordflower-container .hpwf-tools summary:hover, #hp-wordflower-container .hpwf-tool-panel button:hover { transform:translateY(-1px); background:#fff5f6; }
    ...
    #hp-wordflower-container .hpwf-tools { max-width:540px; margin:0 auto 10px; }
    #hp-wordflower-container .hpwf-tools summary { list-style:none; display:flex; align-items:center; justify-content:center; gap:7px; width:100%; }
    #hp-wordflower-container .hpwf-tools summary::-webkit-details-marker { display:none; }
    #hp-wordflower-container .hpwf-tools summary .material-symbols-outlined { font-size:20px; font-variation-settings:'FILL' 1,'wght' 600,'GRAD' 0,'opsz' 24; }
    #hp-wordflower-container .hpwf-tool-panel { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:8px; margin-top:8px; padding:10px; border:1px solid #f7c7ca; background:#fff5f6; border-radius:16px; }
    #hp-wordflower-container .hpwf-tool-panel button { padding:9px 8px; font-size:13px; background:#fff; }
    #hp-wordflower-container .hpwf-tool-panel .hpwf-reveal { border-color:#b9d7ef !important; color:#0F7FBB !important; }
    #hp-wordflower-container .hpwf-tool-panel .hpwf-danger { border-color:#f6b4b9 !important; color:#ED1B24 !important; }
    ...
    #hp-wordflower-container .hpwf-word-list { flex:1 1 auto; min-height:260px; overflow-y:auto; padding-right:6px; }
    ...
    @media(max-width:620px){
      ...
      #hp-wordflower-container .hpwf-progress-card{padding:12px;}
      #hp-wordflower-container .hpwf-progress-meta{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;}
      #hp-wordflower-container .hpwf-progress-stat{padding:7px 4px;}
      #hp-wordflower-container .hpwf-progress-stat strong{font-size:15px;}
      #hp-wordflower-container .hpwf-progress-stat span{font-size:9px;}
      ...
      #hp-wordflower-container .hpwf-flower-core{left:91px;top:91px;width:148px;height:148px;}
      #hp-wordflower-container .hpwf-center-letter{left:118px;top:118px;width:94px;height:94px;font-size:26px;}
      #hp-wordflower-container .hpwf-outer-letter{width:98px;height:98px;font-size:25px;border-width:7px;}
      ...
      #hp-wordflower-container .hpwf-actions{display:grid;grid-template-columns:1.35fr 1fr 1fr;gap:8px;}
      #hp-wordflower-container .hpwf-actions button{padding:10px 8px;font-size:14px;}
      #hp-wordflower-container .hpwf-tools{max-width:none;}
      #hp-wordflower-container .hpwf-tool-panel{grid-template-columns:1fr 1fr;}
  ...
  function renderProgress(){
    ...
    return `<div class="hpwf-progress-card">
      ...
      <div class="hpwf-progress-meta">
        ...
        <div class="hpwf-progress-stat"><strong>${currentScore()} / ${totalScore()}</strong><span>Points</span></div>
      </div>
    </div>`;
  }
  ...
  function render(){
    ...
    mount.innerHTML = `<div class="hpwf-shell"><div class="hpwf-card"><div class="hpwf-layout">
      ...
      <section class="hpwf-panel hpwf-main-panel">
        ...
        <details class="hpwf-tools">
          <summary><span class="material-symbols-outlined" aria-hidden="true">tune</span> Puzzle Tools</summary>
          <div class="hpwf-tool-panel">
      ...
      <div class="hpwf-life-wrap">${renderLifeStats()}</div>
    </div>
