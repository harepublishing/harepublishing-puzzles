/* HARE PUBLISHING CRYPTOGRAM PLATFORM ENGINE v3.7
   Update: Success/Reveal card rebuilt to match Knights & Knaves v2.8 overlay standard. */
  ...
  init({ containerId = "hp-cryptogram-container", dataObject } = {}) {
    ...
    function injectStyles() {
      ...
      style.textContent = `
        ...
        /* v3.7 Success/Reveal overlay matched to Knights & Knaves v2.8 standard */
        #hp-cryptogram-container #hp-crypto-overlay .hp-modal {
        ...
        #hp-cryptogram-container .hp-crypto-overlay-close:hover { background: var(--hp-cg-primary); color: #fff; transform: translateY(-1px); }
        #hp-cryptogram-container .hp-crypto-overlay-close .material-symbols-outlined { font-size: 22px !important; font-variation-settings:'FILL' 0,'wght' 800,'GRAD' 0,'opsz' 24!important; }

        #hp-cryptogram-container #hp-crypto-overlay .hp-crypto-overlay-icon { font-size:30px!important; color:var(--hp-cg-primary-dark); font-variation-settings:'FILL' 1,'wght' 700,'GRAD' 0,'opsz' 40!important; margin-bottom:8px; }
        #hp-cryptogram-container .hp-crypto-overlay-status { font-weight:900; color:#555; margin:0 0 8px; font-size:24px; line-height:1.1; }
        #hp-cryptogram-container #hp-crypto-overlay .hp-modal h3 { margin:0 0 18px; color:var(--hp-cg-primary-dark); font-size:28px; line-height:1.15; font-weight:900; }
        #hp-cryptogram-container #hp-crypto-overlay .hp-result-meta { margin:0; text-align:center; }
        #hp-cryptogram-container #hp-crypto-overlay .hp-result-puzzle-title { display:none; }
        #hp-cryptogram-container #hp-crypto-overlay .hp-result-stats-line { display:flex; flex-wrap:nowrap; justify-content:center; align-items:center; gap:0 18px; color:#555; font-size:14px; line-height:1.25; font-weight:800; margin:12px auto 14px; white-space:nowrap; }
        #hp-cryptogram-container #hp-crypto-overlay .hp-result-stat-chip { display:inline-flex; align-items:center; gap:4px; white-space:nowrap; }
        #hp-cryptogram-container #hp-crypto-overlay .hp-result-stat-chip .material-symbols-outlined { font-size:16px!important; line-height:1; color:var(--hp-cg-primary-dark); font-variation-settings:'FILL' 1,'wght' 700,'GRAD' 0,'opsz' 40!important; }
        #hp-cryptogram-container #hp-crypto-overlay .hp-result-stat-chip strong { color:var(--hp-cg-primary-dark); font-weight:900; }

        #hp-cryptogram-container .hp-crypto-overlay-next-copy { margin:18px auto 16px; display:flex; flex-direction:column; align-items:center; gap:5px; color:#555; font-size:18px; line-height:1.25; font-weight:800; text-align:center; }
        #hp-cryptogram-container .hp-crypto-overlay-next-copy strong { font-size:22px; color:#555; font-weight:900; }
        #hp-cryptogram-container .hp-crypto-overlay-next-copy span { display:block; max-width:620px; }

        #hp-cryptogram-container .hp-crypto-modal-buttons { display:flex!important; justify-content:center!important; align-items:center!important; gap:14px!important; flex-wrap:wrap!important; margin-top:14px!important; }
        #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn { border:2px solid transparent!important; border-radius:14px!important; min-height:42px!important; min-width:220px!important; width:auto!important; padding:10px 22px!important; font-weight:900!important; cursor:pointer!important; text-decoration:none!important; display:inline-flex!important; align-items:center!important; justify-content:center!important; font-family:inherit!important; font-size:14px!important; line-height:1.1!important; transition:all .18s ease!important; grid-column:auto!important; justify-self:auto!important; margin:0!important; }
        #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn.primary { background:var(--hp-cg-primary)!important; color:#fff!important; border-color:var(--hp-cg-primary)!important; min-width:300px!important; }
        #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn.primary:hover { background:#fff!important; border-color:var(--hp-cg-primary-soft)!important; color:var(--hp-cg-primary-dark)!important; transform:translateY(-1px); }
        #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn.secondary,
        #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn.share-action { background:transparent!important; color:var(--hp-cg-primary-dark)!important; border-color:transparent!important; min-width:220px!important; box-shadow:none!important; }
        #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn.secondary:hover,
        #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn.share-action:hover { background:var(--hp-cg-primary-light)!important; border-color:var(--hp-cg-primary-soft)!important; color:var(--hp-cg-primary-dark)!important; transform:translateY(-1px); }

        @media (max-width: 760px) {
          #hp-cryptogram-container #hp-crypto-overlay .hp-modal { width:min(760px,calc(100vw - 24px)); padding:22px 16px; }
