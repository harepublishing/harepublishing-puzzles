    ...
    function renderOverlayNextPanel() {
      ...
      if (alternate && !nextPreferred) {
        ...
        const remainingCopy = hasRemainingModes
          ...
          : "Another challenge is still available.";
      ...
      if (nextPreferred) {
        ...
        const remainingCopy = hasRemainingModes
          ...
          : "";
        overlayNextPanelEl.innerHTML = `
          ${remainingCopy ? `<p class="hp-sudoku-overlay-message">${remainingCopy}</p>` : ""}
          <div class="hp-sudoku-next-panel-actions">
      ...
      if (!anyUnfinished) {
        overlayNextPanelEl.innerHTML = `
          <div class="hp-sudoku-overlay-next-copy">
            ...
            <span>Explore more puzzles in the Puzzlers Hub.</span>
          </div>
          <div class="hp-sudoku-next-panel-actions">
      ...
      overlayNextPanelEl.innerHTML = `
        ...
        <div class="hp-sudoku-next-panel-actions">${shareButton}</div>
      `;
      overlayNextPanelEl.hidden = false;
    }
...
<style>
  ...
  /* =========================================================
     SUDOKU SUCCESS / REVEAL CARD - v3.9
