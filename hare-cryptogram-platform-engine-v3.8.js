/* HARE PUBLISHING CRYPTOGRAM PLATFORM ENGINE v3.8
   Update: realigns Success/Reveal overlay to the Knights & Knaves v2.8 card standard. */
window.HareCryptogramEngine = {
  init({ containerId = "hp-cryptogram-container", dataObject } = {}) {
    ...
    const MORE_PUZZLES_URL = data.morePuzzlesUrl || "https://www.harepublishing.com/puzzlers-hub";
