...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v2.6";
  ...
  function injectStyles() {
    if (document.getElementById("hp-wordflower-platform-engine-css-v26")) return;
    const style = document.createElement("style");
    style.id = "hp-wordflower-platform-engine-css-v26";
  ...
  function showOverlay(kind){
    ...
    if(!overlay||!icon||!status||!title||!meta||!text) return;
