  ...
  init({
    ...
    function renderOverlayContent() {
      ...
      if (state.solved) {
        ...
        overlayTitleEl.textContent = "You Solved It!";
        overlayTextEl.textContent = `You solved ${displayName}.${remainingText}`;
      ...
      if (state.revealed) {
        ...
        overlayTextEl.textContent = `Answer revealed for ${displayName}.${remainingText}`;
        overlayFooterEl.textContent = cfg.footer;
      }
    }
