...
window.HareWordrowEngine = (() => {
  const VERSION = "wordrow-platform-engine-v1.1";
  ...
  const CSS = `
    ...
    @media (max-width: 760px) {
      #hp-wordrow-container .hpwr-grid { width: min(100%, 320px); gap: 7px; }
      #hp-wordrow-container .hpwr-row { gap: 7px; }
      #hp-wordrow-container .hpwr-tile { border-radius: 11px; font-size: 22px; }
  ...
  function injectStyles() {
    if (document.getElementById("hp-wordrow-platform-engine-css-v11")) return;
    const style = document.createElement("style");
    style.id = "hp-wordrow-platform-engine-css-v11";
