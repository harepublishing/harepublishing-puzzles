...
window.HareWordScramblePlatformEngine = (() => {
  const VERSION = "word-scramble-platform-engine-v1.5";
  ...
  function injectStyles(){
    if (document.getElementById("hp-word-scramble-platform-engine-css-v15")) return;
    const style = document.createElement("style");
    style.id = "hp-word-scramble-platform-engine-css-v15";
  ...
  function renderOverlayContent(){
    ...
    if(state.solved){
      ...
      overlayTextEl.innerHTML=`<div class="hp-modal-lead">You completed this Word Scramble<br>using one or more revealed words.</div>${renderRecommendationHtml()}`;
    }
  }
