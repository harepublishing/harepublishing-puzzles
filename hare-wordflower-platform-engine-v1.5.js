...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v1.5";
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-word-panel { display:flex; flex-direction:column; overflow:hidden; min-height:685px; height:685px; }
    ...
    #hp-wordflower-container .hp-modal { width:min(860px,100%); max-height:92vh; overflow:auto; background:#fff; border-radius:24px; box-shadow:0 22px 70px rgba(0,0,0,.28); padding:30px; text-align:center; }
    ...
    #hp-wordflower-container .hpwf-overlay-progress .hpwf-progress-top { grid-template-columns:minmax(160px,auto) minmax(300px,1fr) auto; }
