        ...
        <div class="hp-layout">
          ...
          <div class="hp-col-right hp-rs-right">
            ...
            <div class="hp-btn-grid" aria-label="Number pad">
              ...
              <button class="hp-btn hp-keypad-action-btn hp-notes-keypad-btn" id="hp-notes-btn" type="button" aria-pressed="false" aria-label="Turn notes on" title="Notes off"><span class="hp-keypad-action-symbol notes-symbol" aria-hidden="true">✎</span></button>
              ...
              <button class="hp-btn hp-keypad-action-btn" data-a="erase" type="button" aria-label="Erase cell" title="Erase"><span class="hp-keypad-action-symbol erase-symbol" aria-hidden="true">⌫</span></button>
              ...
              <button class="hp-btn hp-keypad-action-btn" id="hp-undo-btn" data-a="undo" type="button" aria-label="Undo last action" title="Nothing to undo" disabled><span class="hp-keypad-action-symbol undo-symbol" aria-hidden="true">↩</span></button>
            </div>
