  ...
  init({
    ...
    function renderUI() {
      ...
      mount.innerHTML = `<style>
        ...
        #hp-knights-container .hp-knights-top{display:flex;align-items:center;justify-content:center;margin:0 0 8px;padding:6px;border:1px solid #edf2f6;border-radius:14px;background:#fff;}
        ...
        #hp-knights-container .hp-knights-mode-btn{border:1px solid var(--hp-primary-soft);background:#fff;color:var(--hp-primary-dark);border-radius:12px;min-height:30px;padding:5px 8px;font-size:13px;font-weight:900;cursor:pointer;}
        ...
        #hp-knights-container .hp-knights-status{min-height:38px;display:flex;align-items:center;justify-content:center;text-align:center;font-weight:900;color:#444;margin:0 0 10px;padding:7px 10px;border-radius:14px;background:#f7f9fb;border:1px solid #dde7ef;}
        ...
        #hp-knights-container .hp-knights-statements{background:#fff;border:1px solid #e9eef3;border-radius:18px;padding:12px 14px;margin:0 0 12px;box-shadow:0 8px 24px rgba(0,0,0,.045);}
        #hp-knights-container .hp-knights-statements h3{margin:0 0 8px;color:var(--hp-primary-dark);font-size:17px;text-align:center;}
        #hp-knights-container .hp-knights-message-list{display:grid;gap:8px;}
        #hp-knights-container .hp-knights-message{display:grid;grid-template-columns:46px minmax(0,1fr);gap:8px;align-items:end;max-width:92%;}
        #hp-knights-container .hp-knights-message-right{grid-template-columns:minmax(0,1fr) 46px;margin-left:auto;}
        ...
        #hp-knights-container .hp-knights-message-avatar{width:46px;height:46px;border-radius:50%;object-fit:cover;display:block;border:2px solid var(--hp-primary-soft);background:#fff;}
        ...
        #hp-knights-container .hp-knights-message-bubble{position:relative;background:#f7f9fb;border:1px solid #dde7ef;border-radius:16px;padding:8px 10px;color:#222;line-height:1.32;}
        ...
        #hp-knights-container .hp-knights-answer-grid{display:grid;grid-template-columns:repeat(${Math.min(3, getConfig().people.length)},minmax(0,1fr));gap:10px;margin:0 0 12px;}
        #hp-knights-container .hp-knights-person-card{position:relative;border:1px solid #e9eef3;border-radius:18px;background:#fff;padding:10px;box-shadow:0 8px 22px rgba(0,0,0,.045);transition:background-color .18s ease,border-color .18s ease;overflow:hidden;}
        ...
        #hp-knights-container .hp-knights-card-icon{position:absolute;top:9px;left:9px;z-index:3;font-size:24px!important;line-height:1!important;font-variation-settings:'FILL' 1,'wght' 700,'GRAD' 0,'opsz' 40!important;background:rgba(255,255,255,.85);border-radius:50%;}
        ...
        #hp-knights-container .hp-knights-photo-wrap{width:100%;aspect-ratio:4/5;border-radius:14px;overflow:hidden;background:var(--hp-primary-light);border:1px solid var(--hp-primary-soft);margin-bottom:8px;}
        #hp-knights-container .hp-knights-person-photo{width:100%;height:100%;object-fit:cover;display:block;}
        ...
        #hp-knights-container .hp-knights-person-id{display:flex;align-items:center;gap:7px;justify-content:center;margin-bottom:8px;}
        #hp-knights-container .hp-knights-person-id span{display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;border-radius:50%;background:var(--hp-primary);color:#fff;font-weight:900;font-size:13px;}
        #hp-knights-container .hp-knights-person-id strong{font-size:15px;color:#111;}
        #hp-knights-container .hp-knights-choice-row{display:grid;grid-template-columns:1fr 1fr;gap:7px;}
        #hp-knights-container .hp-knights-choice{border:2px solid var(--hp-primary-soft);background:#fff;color:var(--hp-primary-dark);border-radius:13px;padding:7px 6px;font-weight:900;cursor:pointer;font-family:inherit;font-size:13px;}
        ...
        #hp-knights-container .hp-knights-revealed-label{text-align:center;margin-top:7px;font-size:12px;font-weight:900;color:var(--hp-primary-dark);}
        #hp-knights-container .hp-knights-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;}
        #hp-knights-container .hp-knights-actions button,#hp-knights-container .hp-knights-actions a{border:2px solid var(--hp-primary);border-radius:14px;min-height:40px;font-family:inherit;font-weight:900;cursor:pointer;text-decoration:none;display:flex;align-items:center;justify-content:center;text-align:center;}
