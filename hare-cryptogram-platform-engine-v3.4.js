/* HARE PUBLISHING CRYPTOGRAM PLATFORM ENGINE v3.4
   Update: aligns Success/Reveal card with Knights & Knaves overlay standard. */
  ...
  init({ containerId = "hp-cryptogram-container", dataObject } = {}) {
    ...
    function injectStyles() {
      ...
      style.textContent = `
        ...
        /* v3.4 Success/Reveal overlay aligned with Knights & Knaves standard */
        #hp-cryptogram-container #hp-crypto-overlay .hp-modal {
          width: min(720px, 100%);
        ...
        @media (max-width: 760px) {
          ...
          #hp-cryptogram-container .hp-crypto-modal-buttons { gap:10px; }
          #hp-cryptogram-container .hp-crypto-modal-buttons .hp-link-btn { width:100%; min-width:0; }
    ...
    function renderRecommendationHtml() {
      ...
      if (nextPuzzle) {
        ...
        const messageTitle = nextPuzzle.isInProgress ? "Continue where you left off" : "Another Cryptogram is ready";
    ...
    function renderOverlayContent() {
      ...
      if (state.solved) {
        ...
        overlayTextEl.innerHTML = `
          <div class="hp-crypto-overlay-next-copy">
            <strong>Congratulations — you cracked the code!</strong>
            <span>Great job decoding this quote.</span>
          </div>
