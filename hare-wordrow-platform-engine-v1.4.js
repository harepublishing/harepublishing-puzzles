/* =========================================================
   ...
   Gameplay-only engine for the Cryptogram-style Wordrow platform shell
   Updated: 2026-05-19 — mobile action cleanup + reveal answer row

   Suggested filename:
   hare-wordrow-platform-engine-v1.3.js
   ...
   Platform note:
   - This file intentionally exposes window.HareWordrowEngine
   - It does NOT render the outer platform shell/sidebar/archive UI
   ========================================================= */
...
/*
  ...
  -----------------------
  Do not auto-init this engine.
  The Cryptogram-style Wordrow puzzle page loads JSON data first, then calls:
  ...
  This keeps the platform shell and the gameplay engine separated.
*/
