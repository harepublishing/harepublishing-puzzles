...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v2.4";
  ...
  function injectSchema(){
    ...
    const schemaData={
      ...
      "description":puzzleId ? `Play Word Flower Puzzle #${puzzleId} online from Hare Publishing.` : "Play Word Flower online from Hare Publishing.",
      "genre":"Puzzle",
      "url":pageUrl,
      "inLanguage":"en",
