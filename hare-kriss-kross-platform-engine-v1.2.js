...
window.HareKrissKrossPlatformEngine = (() => {
  const VERSION = "kriss-kross-platform-engine-v1.2";
...
/* =========================================================
   ...
   Applied 2026-06-12 from Kriss_Kross_Layout_Redesign_Summary.docx
   Goal: continuous premium crossword-style grid, pale non-playable cells,
   softer frame, improved mobile scaling, and two-column word list.
   ========================================================= */
...
#hp-krisskross-container .hp-kk-cell {
  ...
  color: #16324a;
  border-radius: 0;
  font-size: clamp(.76rem, 1.03vw, .96rem);
  font-weight: 800;
  box-shadow: none;
}
...
@media (min-width: 981px) {
  #hp-krisskross-container .hp-kk-board {
    --hp-kk-cell-size: clamp(26px, 2vw, 31px);
  }
}
...
`;
  ...
  function injectRedesignedKrissKrossCss() {
    ...
    if (existing) {
      existing.textContent = REDESIGNED_KRISS_KROSS_CSS;
      return;
    }
    const style = document.createElement("style");
    style.id = styleId;
