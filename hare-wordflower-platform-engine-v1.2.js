...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v1.1";
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-node-dot { width:36px; height:36px; border-radius:50%; border:2px solid #f1d4d6; background:#fff; color:#b7777c; display:flex; align-items:center; justify-content:center; transition:all .2s ease; }
    #hp-wordflower-container .hpwf-node-dot .material-symbols-outlined { font-size:22px; font-variation-settings:'FILL' 0,'wght' 500,'GRAD' 0,'opsz' 24; }
    ...
    #hp-wordflower-container .hpwf-node.current .hpwf-node-dot { width:46px; height:46px; box-shadow:0 7px 18px rgba(246,141,145,.35); transform:translateY(-3px); }
    #hp-wordflower-container .hpwf-node-label { font-size:10.5px; line-height:1.05; font-weight:900; text-align:center; color:#777; max-width:none; white-space:nowrap; }
    ...
    #hp-wordflower-container .hpwf-word-list { flex:1 1 auto; min-height:260px; max-height:440px; overflow-y:auto; padding-right:6px; scroll-behavior:auto; }
