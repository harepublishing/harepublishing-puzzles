/* =========================================================
   ...
   Suggested filename:
   hare-regular-sudoku-engine-v3.3.js
...
<style>
  ...
  #hp-sudoku-container .hp-help-top-btn img {
    display: block;
    width: 100%;
    height: 100%;
    max-width: 100%;
    ...
    #hp-sudoku-container .hp-rs-level-panel .hp-mode-btn {
     ...
     <div class="hp-puzzle-date">
        ...
        <div class="hp-rs-top-area ${hasMultipleModes ? "" : "single-mode"}">
          ...
          <button class="hp-help-top-btn" data-a="help" type="button" aria-label="Help" title="Help"><img src="${HELP_BUTTON_ICON}" alt=""></button>
        </div>
