...
/* =========================================================
   HARE PUBLISHING KRISS KROSS PLATFORM ENGINE CSS v3.0
   Board model: production Kriss Kross crossword grid
   ========================================================= */
#hp-krisskross-container,
#hp-krisskross-container *{box-sizing:border-box;}
#hp-krisskross-container{width:100%;font-family:Roboto,Arial,sans-serif;color:#24323d;}
#hp-krisskross-container .hp-kk-layout{display:grid;grid-template-columns:minmax(0,1fr) 250px;gap:16px;align-items:stretch;width:100%;max-width:100%;margin:0 auto;}
#hp-krisskross-container .hp-kk-col-left,#hp-krisskross-container .hp-kk-col-right{min-width:0;display:flex;align-self:stretch;}
#hp-krisskross-container .hp-kk-col-right{width:250px;min-width:250px;max-width:250px;}
#hp-krisskross-container .hp-kk-panel{background:#fff;border:1px solid #e9eef3;border-radius:18px;box-shadow:0 8px 24px rgba(0,0,0,.055);padding:16px;min-width:0;}
#hp-krisskross-container .hp-kk-col-left .hp-kk-panel,#hp-krisskross-container .hp-kk-col-right .hp-kk-panel{display:flex;flex-direction:column;width:100%;min-height:650px;height:650px;overflow:hidden;}
#hp-krisskross-container .hp-kk-theme{margin:0 0 14px;color:#2f4667;font-size:24px;line-height:1.15;font-weight:900;text-align:center;text-transform:none;letter-spacing:0;}
...
#hp-krisskross-container .hp-kk-board-wrap{display:flex;justify-content:center;align-items:center;flex:1 1 auto;min-height:0;width:100%;overflow:visible;margin:0;padding:0;background:transparent;border:0;border-radius:0;}
#hp-krisskross-container .hp-kk-board{--hp-kk-cols:16;--hp-kk-rows:18;display:grid;gap:0;width:auto;height:100%;max-width:100%;aspect-ratio:var(--hp-kk-cols) / var(--hp-kk-rows);margin:0 auto;user-select:none;touch-action:manipulation;background:#fff;border:1px solid #b9cbe2;border-radius:18px;overflow:hidden;box-shadow:none;}
#hp-krisskross-container .hp-kk-cell,#hp-krisskross-container .hp-kk-block{width:auto!important;height:auto!important;min-width:0!important;min-height:0!important;padding:0!important;margin:0!important;line-height:1;border-radius:0!important;}
#hp-krisskross-container .hp-kk-block{display:block!important;visibility:visible!important;pointer-events:none;background:#e9eef5;border:1px solid #c9d5e6;}
#hp-krisskross-container .hp-kk-block:nth-child(odd){background:#fdfdfd;}
#hp-krisskross-container .hp-kk-cell{appearance:none;-webkit-appearance:none;display:flex;align-items:center;justify-content:center;border:1px solid #c9d5e6;background:#fff;color:#16324a;font-size:clamp(13px,1.1vw,18px);font-weight:800;cursor:pointer;box-shadow:none;transition:background .16s ease,box-shadow .16s ease,color .16s ease,border-color .16s ease;}
#hp-krisskross-container .hp-kk-cell:hover{background:#eef6ff;border-color:#9ebbd8;}
#hp-krisskross-container .hp-kk-cell.is-filled,#hp-krisskross-container .hp-kk-cell.is-correct,#hp-krisskross-container .hp-kk-cell.is-revealed{background:#fff;color:#16324a;border-color:#c9d5e6;}
#hp-krisskross-container .hp-kk-cell.is-selected{background:#d7e8fa;color:#16324a;border-color:#7ea9d1;box-shadow:inset 0 0 0 2px #6e8fb9;}
#hp-krisskross-container .hp-kk-cell.is-selected.is-slot-start{background:#a9c9ee;color:#16324a;border-color:#6e8fb9;box-shadow:inset 0 0 0 2px #4b6a96;}
#hp-krisskross-container .hp-kk-cell.is-toggle-cell{position:relative;}
#hp-krisskross-container .hp-kk-cell.is-toggle-cell::after{content:"";position:absolute;right:4px;top:4px;width:5px;height:5px;border-radius:999px;background:rgba(16,127,187,.45);}
#hp-krisskross-container .hp-kk-cell.is-selected.is-toggle-cell::after,#hp-krisskross-container .hp-kk-cell.is-selected.is-slot-start.is-toggle-cell::after{background:rgba(47,70,103,.75);}
#hp-krisskross-container .hp-kk-actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-top:14px;padding-top:0;align-items:stretch;}
#hp-krisskross-container .hp-kk-btn,#hp-krisskross-container .hp-tool-btn,#hp-krisskross-container .hp-link-btn{font-family:inherit;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;text-align:center;font-weight:900;transition:all .18s ease;}
#hp-krisskross-container .hp-kk-btn{appearance:none;-webkit-appearance:none;min-height:44px;padding:12px;border-radius:12px;border:2px solid #ddd;background:#fff;color:#333;font-size:14px;line-height:1.05;}
#hp-krisskross-container .hp-kk-btn:hover,#hp-krisskross-container .hp-tool-btn:hover,#hp-krisskross-container .hp-link-btn:hover{transform:translateY(-1px);}
#hp-krisskross-container .hp-kk-btn.reveal{color:#107FBB;border-color:rgba(16,127,187,.35);}
#hp-krisskross-container .hp-kk-btn.danger{color:#ED1B24;border-color:rgba(237,27,36,.35);}
#hp-krisskross-container .hp-puzzle-tools{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0 0 12px;}
#hp-krisskross-container .hp-puzzle-mobile-tools{display:none;}
#hp-krisskross-container .hp-tool-btn{min-height:42px;padding:9px 10px;border-radius:12px;border:2px solid #e1e5ea;background:#fff;color:#333;font-size:13px;line-height:1.05;}
#hp-krisskross-container .hp-tool-btn.hint-toggle{background:#fff;color:#00813f;border-color:#bdeed4;}
#hp-krisskross-container .hp-tool-btn.hint-toggle.active{background:#00A54F;border-color:#00A54F;color:#fff;}
#hp-krisskross-container .hp-tool-btn.clear-tool{background:#fff;color:#333;border-color:#ddd;}
#hp-krisskross-container .hp-tool-btn.danger{background:#fff;color:#ED1B24;border-color:#ffb4b4;}
#hp-krisskross-container .hp-tool-btn.reveal{background:#fff;color:#107FBB;border-color:#b9d7ef;}
#hp-krisskross-container .hp-kk-words-header{display:block;margin:0 0 10px;text-align:center;}
#hp-krisskross-container .hp-kk-words-header h3{margin:0 0 4px;color:#2f4667;font-size:18px;line-height:1.15;font-weight:900;text-align:center;}
#hp-krisskross-container .hp-kk-pill{display:block;padding:0;border:0;background:transparent;color:#3d4b58;font-size:13px;line-height:1.25;font-weight:900;text-align:center;white-space:normal;}
#hp-krisskross-container .hp-kk-word-list{display:grid;grid-template-columns:1fr;gap:7px;align-content:start;flex:1 1 auto;min-height:0;overflow-y:auto;overflow-x:hidden;padding-right:4px;overscroll-behavior:contain;}
#hp-krisskross-container .hp-kk-word-item{appearance:none;-webkit-appearance:none;width:100%;min-width:0;border-radius:11px;border:1px solid #e6edf3;background:#fff;color:#24323d;padding:8px 8px;min-height:34px;text-align:center;font-size:12px;font-weight:900;line-height:1.05;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;transition:transform .12s ease,box-shadow .12s ease,background .2s ease,border-color .2s ease;}
#hp-krisskross-container .hp-kk-word-item:hover{transform:translateY(-1px);box-shadow:0 10px 24px rgba(0,0,0,.06);}
#hp-krisskross-container .hp-kk-word-item.is-match{background:#f3f8ff;border-color:#bfd8ef;color:#107FBB;}
#hp-krisskross-container .hp-kk-word-item.is-used{background:#fffaf1;border-color:#f6dfb1;color:#b87800;}
#hp-krisskross-container .hp-kk-word-item.is-found{background:#eefaf1;border-color:#bfe5ca;color:#0e7a3c;}
#hp-krisskross-container .hp-overlay{display:none;align-items:center;justify-content:center;}
#hp-krisskross-container .hp-overlay.on{display:flex;}
#hp-krisskross-container #hp-kk-overlay{position:absolute;inset:0;z-index:50;background:rgba(255,255,255,.76);border-radius:18px;padding:16px;}
#hp-krisskross-container #hp-kk-help-modal{position:fixed;inset:0;z-index:99999;background:rgba(0,0,0,.45);padding:20px;}
#hp-krisskross-container .hp-modal{background:#fff;width:min(560px,100%);border-radius:22px;padding:26px;box-shadow:0 20px 70px rgba(0,0,0,.25);text-align:center;color:#222;}
#hp-krisskross-container #hp-kk-overlay .hp-modal{width:min(500px,100%);padding:24px 24px 22px;border-radius:18px;box-shadow:0 18px 48px rgba(0,0,0,.18);}
...
#hp-krisskross-container .hp-link-btn{border:2px solid #d8e3ef;background:#fff;color:#2f4667;border-radius:12px;min-height:40px;padding:10px 12px;font-size:13px;}
...
#hp-krisskross-container .hp-link-btn:hover{background:#476695;border-color:#476695;color:#fff;}
...
@media(max-width:980px){
  ...
  #hp-krisskross-container .hp-kk-board{width:100%;height:auto;}
...
`;
    ...
    function injectStyles() {
      if (document.getElementById("hp-kriss-kross-platform-engine-css-v30")) return;
      const style = document.createElement("style");
      style.id = "hp-kriss-kross-platform-engine-css-v30";
