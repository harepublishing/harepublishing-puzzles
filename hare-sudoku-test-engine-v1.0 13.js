...
<style>
  ...
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-keypad-action-icon {
    display: block !important;
  ...
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-keypad-action-btn.active .hp-keypad-action-icon {
  ...
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-keypad-action-btn.disabled .hp-keypad-action-icon,
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-keypad-action-btn:disabled .hp-keypad-action-icon {
  ...
  /* =========================================================
     ...
     ========================================================= */
  #hp-sudoku-container.hp-sudoku-test .hp-keypad-action-btn {
    background: #eef5fb !important;
    border-color: #c9dff1 !important;
    overflow: hidden !important;
  }

  #hp-sudoku-container.hp-sudoku-test .hp-keypad-action-btn .hp-keypad-action-symbol {
    display: inline-flex !important;
    align-items: center !important;
    justify-content: center !important;
    width: 42px !important;
  ...
  #hp-sudoku-container.hp-sudoku-test .hp-keypad-action-btn .hp-keypad-action-icon {
    display: block !important;
    width: 36px !important;
    height: 36px !important;
    min-width: 36px !important;
  ...
  #hp-sudoku-container.hp-sudoku-test .hp-keypad-action-btn.active .hp-keypad-action-icon {
    filter: none !important;
    opacity: 1 !important;
  }

  #hp-sudoku-container.hp-sudoku-test .hp-keypad-action-btn.disabled .hp-keypad-action-icon,
  #hp-sudoku-container.hp-sudoku-test .hp-keypad-action-btn:disabled .hp-keypad-action-icon {
  ...
  /* =========================================================
     ...
     ========================================================= */
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-keypad-action-btn.active .hp-keypad-action-icon,
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-keypad-action-btn.active .hp-keypad-action-symbol img,
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-notes-keypad-btn.active .hp-keypad-action-icon,
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-notes-keypad-btn.active .hp-keypad-action-symbol img {
    filter: none !important;
  ...
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-notes-keypad-btn.active {
    background: #00A54F !important;
    border-color: #00A54F !important;
  }
  ...
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-notes-keypad-btn:not(.active) .hp-keypad-action-icon {
