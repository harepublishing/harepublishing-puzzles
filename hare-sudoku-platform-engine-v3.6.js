...
window.HareSudokuPlatformEngine = {
  init({
    ...
    function renderOverlayNextPanel() {
      ...
      const hasNextRequest = typeof window.HareSudokuRequestNextSudoku === "function";
      ...
      if (hasRemainingModes) {
        ...
        overlayNextPanelEl.innerHTML = `
          ...
          <div class="hp-sudoku-next-panel-actions">
            ...
            ${hasNextRequest ? `<button class="hp-sudoku-next-panel-btn primary" type="button" data-a="request-next-sudoku">Play Your Next Sudoku</button>` : ""}
          </div>
        `;
      ...
      if (hasNextRequest) {
        overlayNextPanelEl.innerHTML = `
          ...
          <button class="hp-sudoku-next-panel-btn primary" type="button" data-a="request-next-sudoku">Play Your Next Sudoku</button>
        `;
        overlayNextPanelEl.hidden = false;
        return;
      }
