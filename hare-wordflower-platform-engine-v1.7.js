...
window.HareWordFlowerEngine = (() => {
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-shell { width:100%; height:100%; }
    #hp-wordflower-container .hpwf-card { background:transparent; border:0; box-shadow:none; padding:0; height:100%; }
    #hp-wordflower-container .hpwf-layout { display:grid; grid-template-columns:minmax(0,1fr) 260px; gap:16px; align-items:stretch; height:100%; }
    ...
    #hp-wordflower-container .hpwf-main-panel { overflow:visible; min-height:685px; height:100%; display:flex; flex-direction:column; }
    #hp-wordflower-container .hpwf-word-panel { display:flex; flex-direction:column; overflow:hidden; min-height:685px; height:100%; }
    ...
    #hp-wordflower-container .hpwf-shell { position:relative; }
    ...
    #hp-wordflower-container .hpwf-overlay-progress .hpwf-progress-top { grid-template-columns:minmax(130px,auto) minmax(260px,1fr) auto; }
    #hp-wordflower-container .hpwf-overlay-progress .hpwf-level-label { font-size:15px; }
    ...
    #hp-wordflower-container .hpwf-overlay-progress .hpwf-progress-stat strong { font-size:13px; }
    #hp-wordflower-container .hpwf-overlay-progress .hpwf-progress-stat span { font-size:8px; }
  ...
  function progressSnapshot(){
    if(state.revealAllUsed && state.revealSnapshot && typeof state.revealSnapshot === "object"){
    ...
    return { found:foundCount(), total:totalCount(), pangrams:pangramsFound().length, pangramTotal:pangrams().length, score:currentScore(), totalScore:totalScore(), pct:completionPct() };
  }
