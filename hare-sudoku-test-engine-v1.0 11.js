...
window.HareSudokuTestEngine = {
  init({
    ...
    const KEYPAD_ICON_BASE_URL = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.9/icons/";
    const KEYPAD_NOTES_ICON = `${KEYPAD_ICON_BASE_URL}notes-button.svg`;
    ...
    function updateNotesButton() {
      ...
      // Keep the SVG icon intact; state is shown by the active class.
    }
...
<style>
  ...
  /* =========================================================
     FINAL KEYPAD SVG ICON NORMALIZATION (images-v1.9)
        ...
        <div class="hp-layout">
          ...
          <div class="hp-col-right hp-rs-right">
            ...
            <div class="hp-btn-grid" aria-label="Number pad">
              ...
              <button class="hp-btn hp-keypad-action-btn hp-notes-keypad-btn" id="hp-notes-btn" type="button" aria-pressed="false" aria-label="Turn notes on" title="Notes off"><span class="hp-keypad-action-symbol notes-symbol" aria-hidden="true"><img class="hp-keypad-action-icon" src="${KEYPAD_NOTES_ICON}" alt=""></span></button>
