  ...
  init({
    ...
    function renderUI({ playMessages = allowNextMessageSound } = {}) {
      ...
      mount.innerHTML = `<style>
        ...
        #hp-knights-container .hp-knights-modal h3{margin:10px 0 6px;color:var(--hp-primary-dark);font-size:28px;line-height:1.15;}
        #hp-knights-container .hp-knights-overlay-status{font-weight:900;color:#555;margin-bottom:12px;font-size:20px;}
