...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v2.7";
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-overlay-progress .hpwf-progress-top {
      grid-template-columns:minmax(160px,auto) minmax(300px,1fr) 80px;
      gap:18px;
      margin-bottom:12px;
    }
    ...
    @media(max-width:560px){
      ...
      #hp-wordflower-container .hp-result-status { font-size:30px; margin-bottom:12px; }
      #hp-wordflower-container .hp-result-title { font-size:32px; margin-bottom:22px; }
      ...
      #hp-wordflower-container .hp-link-btn { width:100%; min-width:0; font-size:18px; min-height:54px; border-radius:18px; }
    }
  ...
  function injectStyles() {
    if (document.getElementById("hp-wordflower-platform-engine-css-v27")) return;
    const style = document.createElement("style");
    style.id = "hp-wordflower-platform-engine-css-v27";
