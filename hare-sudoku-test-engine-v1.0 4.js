...
window.HareSudokuTestEngine = {
  init({
    ...
    const ICON_BASE_URL = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.7/icons/";
...
<style>
  ...
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-rs-level-panel .hp-mode-btn[data-static-mode="medium"] {
    border: 1px solid #107FBB !important;
     ...
     <div class="hp-puzzle-date">
        ...
        <div class="hp-rs-top-area ${hasMultipleModes ? "" : "single-mode"}">
          <div class="hp-rs-level-panel">
            ${hasMultipleModes ? `<div class="hp-rs-level-title">Choose Your Level</div>` : ""}
