/* =========================================================
   ...
   Suggested filename:
   hare-regular-sudoku-engine-v3.4.js
...
window.HareRegularSudokuEngine = {
  init({
    ...
    const ICON_BASE_URL = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.6/icons/";
    ...
    function updateNotesButton() {
      ...
      if (notesToggleIcon) {
        notesToggleIcon.src = notesOn ? NOTES_ON_ICON : NOTES_OFF_ICON;
        notesToggleIcon.alt = "";
      }
    }
...
<style>
  ...
  #hp-sudoku-container .hp-rs-top-area.single-mode {
    justify-content: flex-end;
  }

  #hp-sudoku-container .hp-help-icon-btn {
    display: inline-flex;
    align-items: center;
  ...
  #hp-sudoku-container .hp-help-icon-btn img {
    display: block;
    width: 100%;
    height: 100%;
    max-width: 100%;
  ...
  #hp-sudoku-container .hp-help-icon-btn:hover {
  ...
  #hp-sudoku-container .hp-toolbar-icon-controls {
    display: inline-flex;
    align-items: center;
    justify-content: flex-end;
    gap: 10px;
  ...
  #hp-sudoku-container .hp-timer-toolbar-row .hp-notes-icon-btn,
  #hp-sudoku-container .hp-timer-toolbar-row .hp-erase-icon-btn,
  #hp-sudoku-container .hp-timer-toolbar-row .hp-tools-toggle,
  #hp-sudoku-container .hp-timer-toolbar-row .hp-help-icon-btn {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    box-sizing: border-box;
  ...
  #hp-sudoku-container .hp-timer-toolbar-row .hp-notes-icon-btn img,
  #hp-sudoku-container .hp-timer-toolbar-row .hp-erase-icon-btn img,
  #hp-sudoku-container .hp-timer-toolbar-row .hp-tools-toggle img,
  #hp-sudoku-container .hp-timer-toolbar-row .hp-help-icon-btn img {
    display: block;
    width: 100%;
    height: 100%;
    max-width: 100%;
  ...
  @media (max-width: 900px) {
    ...
    #hp-sudoku-container .hp-layout {
      gap: 12px !important;
    }

    #hp-sudoku-container .hp-col-left {
  ...
  @media (max-width: 480px) {
    ...
    #hp-sudoku-container .hp-rs-level-panel .hp-mode-btn {
     ...
     <div class="hp-puzzle-date">
          ...
          <div class="hp-col-right hp-rs-right">
            <div class="hp-timer-toolbar-row">
              ...
              <div class="hp-toolbar-icon-controls" aria-label="Sudoku quick controls">
                <button class="hp-notes-icon-btn" id="hp-notes-btn" type="button" aria-pressed="false" aria-label="Turn notes on" title="Notes off">
                  <img id="hp-notes-toggle-icon" src="${NOTES_OFF_ICON}" alt="">
                </button>
                <button class="hp-erase-icon-btn" data-a="erase" type="button" aria-label="Erase cell" title="Erase">
                  <img src="${ERASE_BUTTON_ICON}" alt="">
                </button>
      ...
      notesToggleIcon = mount.querySelector("#hp-notes-toggle-icon");
