...
window.HareSudokuPlatformEngine = {
  init({
    ...
    const defaultMode = availableModes.includes(DEFAULT_MODE)
      ? DEFAULT_MODE
      : availableModes[0];
...
<style>
  ...
  /* =========================================================
     PLATFORM OVERLAY CARD - v2.1
     Aligns Sudoku success/reveal cards with Cryptogram/Wordrow.
     ========================================================= */
  ...
  #hp-sudoku-container.hp-sudoku .hp-overlay-stat .material-symbols-outlined {
    ...
    color: #680099 !important;
    font-variation-settings: 'FILL' 1, 'wght' 800, 'GRAD' 0, 'opsz' 24 !important;
  }
  ...
  #hp-sudoku-container.hp-sudoku #hp-overlay .hp-link-btn.primary-action {
    background: #680099 !important;
    border: 2px solid #680099 !important;
    color: #fff !important;
  }
  ...
  #hp-sudoku-container.hp-sudoku #hp-overlay .hp-link-btn:hover,
      ...
      mountClickHandler = (e) => {
        ...
        if (a === "overlay-next-puzzle") {
          ...
          if (nextId && typeof window.HareSudokuLoadPuzzle === "function") {
            window.HareSudokuLoadPuzzle(nextId, { scroll: true });
          } else if (nextId) {
