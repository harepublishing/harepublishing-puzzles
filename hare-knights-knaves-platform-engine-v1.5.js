  ...
  init({
    ...
    function renderUI() {
      ...
      mount.innerHTML = `<style>
        ...
        #hp-knights-container .hp-knights-answer-grid{display:grid;grid-template-columns:repeat(${getConfig().people.length === 4 ? 2 : Math.min(3, getConfig().people.length)},minmax(0,1fr));gap:12px;margin:0 0 12px;}
        #hp-knights-container .hp-knights-person-card{position:relative;border:1px solid #e9eef3;border-radius:18px;background:#fff;padding:8px;box-shadow:0 8px 22px rgba(0,0,0,.045);transition:background-color .18s ease,border-color .18s ease;overflow:hidden;}
        ...
        #hp-knights-container .hp-knights-photo-wrap{position:relative;width:100%;aspect-ratio:4/4.35;border-radius:14px;overflow:hidden;background:var(--hp-primary-light);border:1px solid var(--hp-primary-soft);}
        ...
        #hp-knights-container .hp-knights-card-overlay{position:absolute;left:0;right:0;bottom:0;padding:8px;background:linear-gradient(to top,rgba(0,0,0,.78),rgba(0,0,0,.50),rgba(0,0,0,0));color:#fff;}
        #hp-knights-container .hp-knights-person-id{display:flex;align-items:center;gap:7px;justify-content:center;margin:0 0 6px;min-width:0;}
        #hp-knights-container .hp-knights-person-id span{display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;border-radius:50%;background:var(--hp-primary);color:#fff;font-weight:900;font-size:12px;flex:0 0 auto;}
        #hp-knights-container .hp-knights-person-id strong{font-size:14px;line-height:1;color:#fff;text-shadow:0 1px 3px rgba(0,0,0,.45);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
        #hp-knights-container .hp-knights-choice-toggle{display:grid;grid-template-columns:1fr 1fr;background:rgba(255,255,255,.92);border:1px solid rgba(255,255,255,.75);border-radius:999px;padding:3px;gap:3px;}
        #hp-knights-container .hp-knights-choice{border:0;background:transparent;color:var(--hp-primary-dark);border-radius:999px;padding:5px 6px;font-weight:900;cursor:pointer;font-family:inherit;font-size:12px;line-height:1.1;}
        ...
        #hp-knights-container .hp-knights-actions{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:4px;}
