...
window.HareWordFlowerEngine = (() => {
  ...
  function submit(){
    ...
    const reachedNewLevel=afterLevelIndex > beforeLevelIndex;
    if(pangram && reachedNewLevel){
      setMessage(`Fantastic! ${word} is a pangram — ${afterLevel.label} achieved!`, "pangram");
    }else if(pangram){
      setMessage(`Fantastic! ${word} is a pangram!`, "pangram");
    }else if(reachedNewLevel){
      setMessage(achievementMessage(afterLevel), "milestone");
    }else{
