...
window.HareWordrowEngine = (() => {
  const VERSION = "wordrow-platform-engine-v2.7";
  ...
  function injectSchema() {
    ...
    const schemaData = {
      ...
      "description": `Play ${puzzleTitle || "Wordrow"} online from Hare Publishing. Guess the hidden word, save your progress, and reveal the answer when you need it.`,
      "url": pageUrl,
      ...
      "keywords": ["Wordrow", "word puzzle", "word guessing game", "daily puzzle", "online puzzle", "Hare Publishing"],
      "audience": {
        "@type": "PeopleAudience",
        "suggestedMinAge": "8"
      },
