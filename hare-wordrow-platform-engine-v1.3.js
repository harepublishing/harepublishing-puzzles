...
window.HareWordrowEngine = (() => {
  const VERSION = "wordrow-platform-engine-v1.3";
  ...
  function injectStyles() {
    if (document.getElementById("hp-wordrow-platform-engine-css-v13")) return;
    const style = document.createElement("style");
    style.id = "hp-wordrow-platform-engine-css-v13";
          ...
          <div class="hp-overlay" id="hp-wordrow-overlay" aria-hidden="true">
            <div class="hp-modal" role="dialog" aria-modal="true" aria-label="Wordrow result">
              ...
              <div class="hp-modal-actions">
                ...
                <button class="hp-link-btn danger hp-start-over-btn" data-a="start-over">Start Over</button>
              </div>
