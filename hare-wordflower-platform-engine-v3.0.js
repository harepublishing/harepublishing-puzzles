...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v3.0";
  ...
  const CSS = `
    ...
    @media(max-width:620px){
      ...
      #hp-wordflower-container .hpwf-life-stats{grid-template-columns:repeat(2,minmax(0,1fr)); gap:7px; padding:10px;}
      #hp-wordflower-container .hpwf-life-title{grid-column:1 / -1; text-align:center;}
      #hp-wordflower-container .hpwf-life-grid{display:contents;}
  ...
  function render(){
    ...
    mount.innerHTML = `<div class="hpwf-shell"><div class="hpwf-card"><div class="hpwf-layout">
      <div class="hpwf-progress-wrap">${renderProgress()}${renderLifeStats()}</div>
