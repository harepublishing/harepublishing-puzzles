...
window.HareWordFlowerEngine = (() => {
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-main-panel { overflow:visible; min-height:610px; }
    #hp-wordflower-container .hpwf-word-panel { display:flex; flex-direction:column; overflow:hidden; min-height:610px; }
    ...
    @media(max-width:1020px){
      ...
      #hp-wordflower-container .hpwf-main-panel{min-height:auto;}
      #hp-wordflower-container .hpwf-word-panel{max-height:none; min-height:auto;}
