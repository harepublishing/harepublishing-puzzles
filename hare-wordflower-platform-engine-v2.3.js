...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v2.3";
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-main-panel { overflow:visible; min-height:610px; height:610px; display:flex; flex-direction:column; }
    #hp-wordflower-container .hpwf-word-panel { display:flex; flex-direction:column; overflow:hidden; min-height:610px; height:610px; }
  ...
  function injectStyles() {
    if (document.getElementById("hp-wordflower-platform-engine-css-v23")) return;
    const style = document.createElement("style");
    style.id = "hp-wordflower-platform-engine-css-v23";
