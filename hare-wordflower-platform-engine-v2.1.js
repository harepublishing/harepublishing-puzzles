...
window.HareWordFlowerEngine = (() => {
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-word-item { border:1px solid #e1e8ee; border-radius:12px; padding:6px 8px; margin-bottom:6px; background:#fff; display:grid; grid-template-columns:minmax(0,1fr) auto; align-items:center; gap:8px; }
    ...
    #hp-wordflower-container .hpwf-word-text { font-weight:900; color:#222; font-size:13px; line-height:1.15; min-width:0; display:flex; align-items:center; gap:7px; }
    ...
    #hp-wordflower-container .hpwf-word-meta { display:flex; gap:5px; align-items:center; flex-wrap:nowrap; justify-content:flex-end; }
    #hp-wordflower-container .hpwf-pill { display:inline-flex; align-items:center; justify-content:center; border-radius:999px; border:1px solid #dde7ef; background:#f7f9fb; color:#555; font-size:9px; font-weight:900; padding:4px 7px; text-transform:uppercase; white-space:nowrap; }
    ...
    #hp-wordflower-container .hp-modal.master .hp-modal-actions { display:none; }
  ...
  function vineFillWidthForPct(pct){
    ...
    return currentPos + ((nextPos - currentPos) * ratio);
  }
