window.HareCryptogramEngine = {
  init({ containerId = "hp-cryptogram-container", dataObject } = {}) {
    ...
    function getOverlayStatsLine() {
      ...
      return `Day Streak: ${stats.streak.toLocaleString()} • Solved: ${stats.solved.toLocaleString()} • Revealed: ${stats.revealed.toLocaleString()} • Played: ${stats.played.toLocaleString()}`;
    }
    ...
    function renderOverlayContent() {
      ...
      badgeMetaEl.textContent = getOverlayStatsLine();
