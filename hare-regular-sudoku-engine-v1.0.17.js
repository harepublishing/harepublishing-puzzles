          ...
          <div class="hp-rs-top-timer">
            <div class="hp-timer-area" aria-label="Timer">
              ...
              <div class="hp-timer-controls">
                <button class="hp-btn-sm" data-a="t-start" aria-label="Start timer" title="Start">▶</button>
                <button class="hp-btn-sm" data-a="t-pause" aria-label="Pause timer" title="Pause">❚❚</button>
                <button class="hp-btn-sm" data-a="t-reset" aria-label="Reset timer" title="Reset">↺</button>
              </div>
            </div>
          </div>
        </div>
