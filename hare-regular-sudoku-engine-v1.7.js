/* =========================================================
   ...
   Suggested filename:
   hare-regular-sudoku-engine-v2.3.js
...
window.HareRegularSudokuEngine = {
  init({
    ...
    const TIMER_PLAY_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.0/icons/sudoku-play-button.svg";
    const TIMER_PAUSE_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.0/icons/sudoku-pause-button.svg";
    const TOOLS_CLOSED_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.0/icons/sudoku-tools_icon.svg";
    const TOOLS_OPEN_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.1/icons/sudoku-tools_icon-open.svg";
    ...
    function buildBoard() {
      ...
      cfg.puzzle.split("").forEach((char, i) => {
        ...
        function selectCell() {
          ...
          applyHintHighlights();
          statEl.textContent = getSelectedCellText(i);
          cell.focus();
        }
...
mount.innerHTML = `
        <style>
          ...
          #hp-sudoku-container .hp-rs-top-timer .hp-timer-toggle {
            border:0;
            background:transparent;
            box-shadow:none;
            overflow:hidden;
          ...
          #hp-sudoku-container .hp-rs-top-timer .hp-timer-toggle img {
            display:block;
            width:100%;
            height:100%;
          }
          ...
          #hp-sudoku-container .hp-tools-shell {
            width:100%;
            margin:0 0 12px;
          }

          #hp-sudoku-container .hp-tools-toggle-row {
            display:flex;
            justify-content:flex-end;
            align-items:center;
            margin:0 0 8px;
          ...
          #hp-sudoku-container .hp-tools-toggle {
            display:inline-flex;
            align-items:center;
            justify-content:center;
            width:42px;
          ...
          #hp-sudoku-container .hp-tools-toggle img {
            display:block;
            width:100%;
            height:100%;
          }
          ...
          #hp-sudoku-container .hp-rs-tools .hp-tool-btn.help-info {
     ...
     <div class="hp-puzzle-date">
        ...
        <div class="hp-layout">
          ...
          <div class="hp-col-right hp-rs-right">
            <div class="hp-tools-shell">
              <div class="hp-tools-toggle-row">
              ...
              <div class="hp-tools-tray" id="hp-tools-tray" aria-hidden="true">
                <div class="hp-puzzle-tools hp-rs-tools" aria-label="Sudoku tools">
                  <button class="hp-tool-btn help-info" data-a="help" type="button">Help</button>
