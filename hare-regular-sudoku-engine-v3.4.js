...
window.HareRegularSudokuEngine = {
  init({
    ...
    const HELP_BUTTON_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.5/icons/help-button.svg";
    const TIMER_PLAY_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.5/icons/timer-play-button.svg";
    const TIMER_PAUSE_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.5/icons/timer-pause-button.svg";
    const TOOLS_CLOSED_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.5/icons/toolbar-closed-button.svg";
    const TOOLS_OPEN_ICON = "https://cdn.jsdelivr.net/gh/harepublishing/harepublishing-puzzles@images-v1.5/icons/toolbar-open-button.svg";
        ...
        <div class="hp-layout">
          ...
          <div class="hp-col-right hp-rs-right">
            <div class="hp-timer-toolbar-row">
              ...
              <div class="hp-toolbar-icon-controls" aria-label="Help and tools">
