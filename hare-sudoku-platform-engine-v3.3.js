  ...
  init({
    ...
    function renderOverlayNextPanel() {
      ...
      if (typeof window.HareSudokuGetNextPuzzle === "function") {
        try {
          nextPuzzle = window.HareSudokuGetNextPuzzle({ excludePuzzleId: cfg.puzzleId });
        } catch (err) {
      ...
      if (hasRemainingModes) {
        ...
        overlayNextPanelEl.innerHTML = `
          ...
          <div class="hp-sudoku-next-panel-actions">
            ...
            ${nextPuzzle && nextPuzzle.puzzleId ? `<button class="hp-sudoku-next-panel-btn primary" type="button" data-a="overlay-next-puzzle" data-puzzle-id="${escapeHtml(nextPuzzle.puzzleId)}">Play Your Next Sudoku</button>` : ""}
          </div>
        `;
      ...
      if (nextPuzzle && nextPuzzle.puzzleId) {
        overlayNextPanelEl.innerHTML = `
          ...
          <button class="hp-sudoku-next-panel-btn primary" type="button" data-a="overlay-next-puzzle" data-puzzle-id="${escapeHtml(nextPuzzle.puzzleId)}">Sudoku #${escapeHtml(nextPuzzle.puzzleId)}</button>
        `;
        overlayNextPanelEl.hidden = false;
        return;
      }
