...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-clean-platform-v2";
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-layout { display:grid; grid-template-columns:minmax(0,1fr) 280px; gap:18px; align-items:stretch; }
    ...
    #hp-wordflower-container .hpwf-progress-card { background:linear-gradient(135deg,#fff 0%,#fff 64%,#fff5f6 64%,#fff5f6 100%); border:1px solid #f7c7ca; border-radius:18px; padding:12px 14px; }
    #hp-wordflower-container .hpwf-progress-top { display:grid; grid-template-columns:minmax(170px,auto) minmax(260px,1fr) auto; align-items:center; gap:18px; margin-bottom:8px; }
    ...
    #hp-wordflower-container .hpwf-progress-meta { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:8px; align-items:center; }
    #hp-wordflower-container .hpwf-progress-stat { background:#fff; border:1px solid #f7c7ca; border-radius:12px; padding:7px 8px; text-align:center; min-width:0; }
    ...
    #hp-wordflower-container .hpwf-flower { position:relative; width:min(330px,100%); height:330px; max-width:100%; flex:0 0 auto; }
    #hp-wordflower-container .hpwf-flower-core { position:absolute; left:93px; top:93px; width:144px; height:144px; border-radius:50%; background:radial-gradient(circle at 35% 30%,#fff 0%,#fff7f7 50%,#fff0f1 100%); border:10px solid #fff; box-shadow:0 0 0 12px rgba(246,141,145,.18), 0 14px 32px rgba(0,0,0,.10); z-index:4; pointer-events:none; }
    ...
    #hp-wordflower-container .hpwf-center-letter { left:105px; top:105px; width:120px; height:120px; background:#F68D91; color:#fff; border:10px solid #fff; z-index:5; box-shadow:0 0 0 10px rgba(246,141,145,.32), 0 16px 32px rgba(246,141,145,.35); font-size:34px; }
    ...
    #hp-wordflower-container .hpwf-outer-letter { width:92px; height:92px; z-index:2; }
    #hp-wordflower-container .hpwf-pos-0 { left:119px; top:2px; }
    #hp-wordflower-container .hpwf-pos-1 { left:215px; top:58px; }
    #hp-wordflower-container .hpwf-pos-2 { left:215px; top:180px; }
    #hp-wordflower-container .hpwf-pos-3 { left:119px; top:236px; }
    #hp-wordflower-container .hpwf-pos-4 { left:23px; top:180px; }
    #hp-wordflower-container .hpwf-pos-5 { left:23px; top:58px; }
    ...
    #hp-wordflower-container .hpwf-word-panel h3 { margin:0 0 10px; text-align:center; font-size:21px; line-height:1.1; color:#9d4147; font-weight:900; }
    ...
    #hp-wordflower-container .hpwf-word-item { border:1px solid #e1e8ee; border-radius:12px; padding:7px 9px; margin-bottom:6px; background:#fff; display:flex; align-items:center; justify-content:space-between; gap:8px; }
    ...
    #hp-wordflower-container .hpwf-word-text { font-weight:900; color:#222; font-size:14px; line-height:1.15; }
    ...
    @media(max-width:620px){
      ...
      #hp-wordflower-container .hpwf-progress-top{grid-template-columns:1fr; gap:10px; text-align:center;}
      #hp-wordflower-container .hpwf-current-level{justify-content:center;}
      #hp-wordflower-container .hpwf-progress-percent{text-align:center;}
      ...
      #hp-wordflower-container .hpwf-flower-wrap{overflow:hidden;}
      #hp-wordflower-container .hpwf-flower{width:min(315px,100%);height:315px;}
      #hp-wordflower-container .hpwf-flower-core{left:89px;top:89px;width:137px;height:137px;border-width:9px;}
      #hp-wordflower-container .hpwf-center-letter{left:101px;top:101px;width:113px;height:113px;font-size:30px;border-width:9px;}
      #hp-wordflower-container .hpwf-outer-letter{width:88px;height:88px;font-size:25px;border-width:7px;}
      #hp-wordflower-container .hpwf-pos-0{left:113px;top:2px;}
      #hp-wordflower-container .hpwf-pos-1{left:204px;top:55px;}
      #hp-wordflower-container .hpwf-pos-2{left:204px;top:172px;}
      #hp-wordflower-container .hpwf-pos-3{left:113px;top:225px;}
      #hp-wordflower-container .hpwf-pos-4{left:22px;top:172px;}
      #hp-wordflower-container .hpwf-pos-5{left:22px;top:55px;}
    ...
    mount.innerHTML = `<div class="hpwf-shell"><div class="hpwf-card"><div class="hpwf-layout">
      ...
      <div class="hp-overlay" id="hpwf-overlay" aria-hidden="true"><div class="hp-modal" role="dialog" aria-modal="true" aria-label="Word Flower result">
        ...
        <div class="hp-modal-actions">
          ...
          <button type="button" class="hp-link-btn danger" data-a="reset">Start Over</button>
        </div>
