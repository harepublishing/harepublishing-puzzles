/* =========================================================
   ...
   Suggested filename:
   hare-regular-sudoku-engine-v1.0.10.js
    ...
    function buildBoard() {
      ...
      cfg.puzzle.split("").forEach((char, i) => {
        ...
        function selectCell() {
          ...
          applyHintHighlights();
          statEl.textContent = char === "." ? "Use the number pad or your keyboard." : "Given number selected.";
          cell.focus();
        }
...
mount.innerHTML = `
        <style>
          ...
          #hp-sudoku-container .hp-rs-top-area .hp-mode-switch {
        ...
        <div class="hp-rs-top-area">
          ...
          <div class="hp-mode-switch-wrap">
            <div class="hp-mode-switch" role="tablist" aria-label="Choose Sudoku difficulty">
              <button class="hp-mode-btn ${currentMode === "easy" ? "active" : ""}" data-mode="easy" role="tab" aria-selected="${currentMode === "easy" ? "true" : "false"}">Easy</button>
              <button class="hp-mode-btn ${currentMode === "medium" ? "active" : ""}" data-mode="medium" role="tab" aria-selected="${currentMode === "medium" ? "true" : "false"}">Medium</button>
              <button class="hp-mode-btn ${currentMode === "hard" ? "active" : ""}" data-mode="hard" role="tab" aria-selected="${currentMode === "hard" ? "true" : "false"}">Hard</button>
            </div>
          </div>
          ...
          <div class="hp-puzzle-tools hp-rs-tools" aria-label="Sudoku tools">
            ...
            <button class="hp-tool-btn clear-tool" data-a="clear" type="button">Clear</button>
