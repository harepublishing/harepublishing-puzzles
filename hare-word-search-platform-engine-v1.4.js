/* =========================================================
   ...
   Updated: 2026-06-13 v1.4 — platform release tag fix

   Suggested filename:
   hare-word-search-platform-engine-v1.4.js
...
// Word Search platform engine v1.0.
// Clean production-ready build for the platform page.
// Result modal opens on every puzzle load once solved/revealed.
