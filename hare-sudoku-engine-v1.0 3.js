...
<style>
  ...
  #hp-sudoku-container.hp-sudoku .hp-notes-keypad-btn:not(.active) .hp-keypad-action-icon {
    ...
    beforeUnloadHandler = persistCurrentStateForExit;

    window.addEventListener("beforeunload", beforeUnloadHandler);
    window.addEventListener("pagehide", persistCurrentStateForExit);
    document.addEventListener("visibilitychange", () => {
      if (document.visibilityState === "hidden") persistCurrentStateForExit();
    });
