...
window.HareWordFlowerEngine = (() => {
  const VERSION = "wordflower-platform-v1.2";
  ...
  const CSS = `
    ...
    #hp-wordflower-container .hpwf-main-panel { overflow:visible; min-height:520px; }
    #hp-wordflower-container .hpwf-word-panel { display:flex; flex-direction:column; overflow:hidden; min-height:520px; }
    ...
    #hp-wordflower-container .hpwf-word-list { flex:1 1 auto; min-height:260px; max-height:none; overflow-y:auto; padding-right:6px; scroll-behavior:auto; }
    ...
    @media(max-width:620px){
      ...
      #hp-wordflower-container .hpwf-vine::before{left:7%;right:7%;}
  ...
  function injectStyles() {
    if (document.getElementById("hp-wordflower-platform-engine-css-v12")) return;
    const style = document.createElement("style");
    style.id = "hp-wordflower-platform-engine-css-v12";
