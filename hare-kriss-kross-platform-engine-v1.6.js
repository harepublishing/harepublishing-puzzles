...
window.HareKrissKrossPlatformEngine = (() => {
  const VERSION = "kriss-kross-platform-engine-v1.6";
  ...
  function injectCopiedProductionCss() {
    /*
      ...
      Earlier test builds used the same style id. In Squarespace/browser sessions,
      that allowed an older platform stylesheet to remain in the DOM and stop the
      corrected crossword-style grid CSS from loading. This removes only the
      platform-owned Kriss Kross style nodes, then inserts one fresh stylesheet.
    */
    [
      "hp-kriss-kross-platform-copied-production-css",
      "hp-kriss-kross-platform-copied-production-css-v1-6"
    ].forEach(id => {
    ...
    style.id = "hp-kriss-kross-platform-copied-production-css-v1-6";
  ...
  return {
    ...
    container.classList.add("hp-kk-platform-v15");
