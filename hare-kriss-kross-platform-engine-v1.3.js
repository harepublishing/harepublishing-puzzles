/* =========================================================
   ...
   Self-contained: includes copied production shared CSS + Kriss Kross CSS
   Exposes: window.HareKrissKrossPlatformEngine
   Storage prefix: hp_kk_
   ========================================================= */

window.HareKrissKrossPlatformEngine = (() => {
  const VERSION = "kriss-kross-platform-engine-v1.3";
  ...
  const REDESIGNED_KRISS_KROSS_CSS = `
/* =========================================================
   KRISS KROSS PLATFORM REDESIGN OVERRIDES
   Version 1.3: hardened against legacy Squarespace code-injection CSS
   ========================================================= */

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-panel {
  border-color: #e9eef3 !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-board-wrap {
...
html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-board {
  --hp-kk-gap: 0px !important;
  --hp-kk-cell-size: clamp(25px, 2.15vw, 31px) !important;
  display: inline-grid !important;
  gap: 0 !important;
  width: auto !important;
  max-width: 100% !important;
  padding: 0 !important;
  background: #a9bbd4 !important;
  border: 1px solid #a9bbd4 !important;
  border-radius: 8px !important;
  overflow: hidden !important;
  box-shadow: 0 10px 26px rgba(71,102,149,.10) !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell,
html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-block {
  width: var(--hp-kk-cell-size) !important;
  height: var(--hp-kk-cell-size) !important;
  min-width: var(--hp-kk-cell-size) !important;
  min-height: var(--hp-kk-cell-size) !important;
  border-radius: 0 !important;
  margin: 0 !important;
}
...
html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell {
  ...
  font-size: clamp(.76rem, 1.03vw, .96rem) !important;
  font-weight: 800 !important;
  box-shadow: none !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell:hover {
  background: #f4f9ff !important;
  border-color: #8ea7c8 !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell.is-filled,
html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell.is-correct,
html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell.is-revealed {
  background: #ffffff !important;
  color: #16324a !important;
  border-color: #a9bbd4 !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell.is-selected {
  background: #dbeaf8 !important;
  color: #16324a !important;
  border-color: #7fa0c7 !important;
  box-shadow: inset 0 0 0 2px rgba(71,102,149,.26) !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell.is-selected.is-slot-start {
  background: #c9dff4 !important;
  color: #12324c !important;
  border-color: #6d90ba !important;
  box-shadow: inset 0 0 0 2px rgba(71,102,149,.36) !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-cell.is-toggle-cell::after {
  right: 3px !important;
  top: 3px !important;
  width: 4px !important;
  height: 4px !important;
  background: rgba(71,102,149,.35) !important;
}

html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-word-list {
...
@media (min-width: 981px) {
  html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-board {
    --hp-kk-cell-size: clamp(26px, 2vw, 31px) !important;
  }
}
...
@media (max-width: 980px) {
  ...
  html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-board {
    --hp-kk-cell-size: clamp(21px, calc((100vw - 46px) / 16), 31px) !important;
  }
}

@media (max-width: 700px) {
  html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-board {
    --hp-kk-cell-size: clamp(19px, calc((100vw - 34px) / 16), 28px) !important;
  }
}

@media (max-width: 560px) {
  html body #hp-kriss-kross-platform #hp-krisskross-container .hp-kk-board {
    --hp-kk-cell-size: clamp(18px, calc((100vw - 30px) / 16), 25px) !important;
  }
...
`;
  ...
  let redesignCssKeepAliveStarted = false;

  function injectRedesignedKrissKrossCss() {
    const styleId = "hp-kriss-kross-platform-redesign-css";
    ...
    style.textContent = REDESIGNED_KRISS_KROSS_CSS;
    // Important for Squarespace: re-append so this style remains after code-injection CSS.
    document.head.appendChild(style);
  }

  function keepRedesignCssLast() {
    if (redesignCssKeepAliveStarted || !document.head) return;
    redesignCssKeepAliveStarted = true;
    ...
    const pushLast = () => {
      ...
      window.requestAnimationFrame(() => {
        pending = false;
        injectRedesignedKrissKrossCss();
      });
    };

    const observer = new MutationObserver(pushLast);
    observer.observe(document.head, { childList: true });
    window.setTimeout(pushLast, 0);
    window.setTimeout(pushLast, 250);
    window.setTimeout(pushLast, 1000);
    window.setTimeout(pushLast, 2500);
  }

  function openHelp(containerId = "hp-krisskross-container") {
  ...
  return {
    ...
    container.classList.add("hp-kk-platform-v13");
