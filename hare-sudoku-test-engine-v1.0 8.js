...
<style>
  ...
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-rs-level-panel .hp-mode-btn:focus,
  #hp-sudoku-container.hp-sudoku-test.hp-sudoku-test .hp-rs-level-panel .hp-mode-btn:active {
    border-width: 1px !important;
    transform: none !important;
    box-shadow: none !important;
        ...
        <div class="hp-layout">
          ...
          <div class="hp-col-right hp-rs-right">
            ...
            <div class="hp-btn-grid" aria-label="Number pad">
              ...
              <button class="hp-btn hp-keypad-action-btn hp-notes-keypad-btn" id="hp-notes-btn" type="button" aria-pressed="false" aria-label="Turn notes on" title="Notes off">✎</button>
              ...
              <button class="hp-btn hp-keypad-action-btn" data-a="erase" type="button" aria-label="Erase cell" title="Erase">⌫</button>
              ...
              <button class="hp-btn hp-keypad-action-btn" id="hp-undo-btn" data-a="undo" type="button" aria-label="Undo last action" title="Nothing to undo" disabled>↶</button>
            </div>
